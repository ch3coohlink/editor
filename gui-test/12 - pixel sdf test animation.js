...
fn dis2terraincol(d: f32) -> vec3f {
  ...
  if(d < 0.3) { return c0; }
  else if(d < 0.4) { return c1; }
  else if(d < 0.5) { return c2; }
  else if(d < 0.6) { return c3; }
  else if(d < 0.7) { return c4; }
  else if(d < 0.8) { return c5; }
  else if(d < 0.9) { return c6; }
  else { return c7; }
}
...
fn sdf(ouv: vec2f) -> f32 {
  let iuv = floor(ouv); var uv = ouv - iuv;
  // let tl = sdfcircle(iuv + vec2(0, 1)); let tr = sdfcircle(iuv + vec2(1));
  // let bl = sdfcircle(iuv); let br = sdfcircle(iuv + vec2(1, 0));
