...
function diff3MergeRegions(a, o, b) {
  ...
  while (hunks.length) {
    ...
    if (regionHunks.length === 1) {
      ...
      if (hunk.abLength > 0) {
        ...
        results.push({
          stable: true, buffer: hunk.ab,
          bufferStart: hunk.abStart, bufferLength: hunk.abLength,
      ...
      while (regionHunks.length) {
        ...
        const oStart = hunk.oStart, oEnd = oStart + hunk.oLength;
        const abStart = hunk.abStart, abEnd = abStart + hunk.abLength;
        let b = bounds[hunk.ab];
        b[0] = Math.min(abStart, b[0]); b[1] = Math.max(abEnd, b[1]);
        b[2] = Math.min(oStart, b[2]); b[3] = Math.max(oEnd, b[3]);
      }
      ...
      results.push({
        ...
        oStart: regionStart, oLength: regionEnd - regionStart,
        oContent: o.slice(regionStart, regionEnd),
        bStart: bStart, bLength: bEnd - bStart,
  ...
  results.forEach(o => log(...o.bufferContent ?? [o.oContent, o.aContent, o.bContent]))
